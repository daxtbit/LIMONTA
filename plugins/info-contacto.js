...
description = official[0][0] == String(contact[0]) ? 'Solo temas de CharlieBot' : official[1][0] == String(contact[0]) ? lenguajeGB.smsContacto4() : official[2][0] == String(contact[0]) ? lenguajeGB.smsContacto4() : official[3][0] == String(contact[0]) ? lenguajeGB.smsContacto4() : desc === '' ? lenguajeGB.smsContacto5() : desc
...
lugar = official[0][0] == String(contact[0]) ? '🇵🇪 Perú' : official[1][0] == String(contact[0]) ? '🇵🇪 Perú' : official[2][0] == String(contact[0]) ? '🇵🇪 Perú' : official[3][0] == String(contact[0]) ? '🇺🇾 Uruguay' : country === '' ? lenguajeGB.smsContacto7() : country
enlace = official[0][0] == String(contact[0]) ? 'https://github.com/Emergit2006' : official[1][0] == String(contact[0]) ? 'https://github.com/Emergit2006' : official[2][0] == String(contact[0]) ? 'https://github.com/Emergit2006' : official[3][0] == String(contact[0]) ? 'https://github.com/Emergit2006' : md 
